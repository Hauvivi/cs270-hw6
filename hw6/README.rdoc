Name: Vivien Hau, CS 270, Assignment 6
Description: Building the views
...
Fill in the view file for each GET request method as appropriate so that the correct information
